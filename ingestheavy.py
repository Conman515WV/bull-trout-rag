...
try:
    chroma.delete_collection(name="yakima")
    log("Deleted old Chroma collection")
except Exception:
    pass
...
log("Saving BM25 index...")
with open(BM25_PATH, "wb") as f:
    pickle.dump({"bm25": bm25, "texts": bm25_texts, "metadata": bm25_metadata}, f)
